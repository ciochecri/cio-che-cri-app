"use strict";(self.webpackChunktest_netlify_deployment=self.webpackChunktest_netlify_deployment||[]).push([[676],{1676:(e,r,s)=>{s.r(r),s.d(r,{default:()=>O});var a=s(7157),n=s(4647),t=s(9281),i=s(3614),l=s(5043),d=s(6904);const o={name:"",email:"",message:""};function m(e){let r={};return e.name||(r.name="Name is required"),e.email?/\S+@\S+\.\S+/.test(e.email)||(r.email="Email address is invalid"):r.email="Email address is required",e.message||(r.message="Message is required"),r}var c=s(5639),h=s(9);const p=(0,h.Ay)("p")`
  margin-top: 1.5rem;
`,x=(0,h.Ay)("div")`
  position: relative;
  max-width: 700px;
`,g=(0,h.Ay)("div")`
  border-radius: 3rem;
  max-width: 400px;
`;var u=s(579);const y=(0,t.C)()((e=>{let{title:r,content:s,t:a}=e;return(0,u.jsxs)(x,{children:[(0,u.jsx)("h6",{children:a(r)}),(0,u.jsx)(g,{children:(0,u.jsx)(p,{children:a(s)})})]})})),j=(0,h.Ay)("div")`
